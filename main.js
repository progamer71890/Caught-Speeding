...
function btnClicked() {
  ...
  document.getElementById("d1-ticket").innerHTML = ticket(d1Speed, d1Limit);
  document.getElementById("d2-ticket").innerHTML = ticket(d2Speed, d2Limit);
  document.getElementById("d3-ticket").innerHTML = ticket(d3Speed, d3Limit);
}
